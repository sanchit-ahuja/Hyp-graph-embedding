...
class Parameter(torch.nn.Parameter):
    def __new__(cls, data=None, requires_grad=True, manifold=None, p_manifold=None):
        if data is None:
    ...
    def __init__(self, data=None, requires_grad=True, manifold=None, p_manifold=None):
